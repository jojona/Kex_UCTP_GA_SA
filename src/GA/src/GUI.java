...
public class GUI extends JFrame implements ActionListener {
  ...
  private void init() {
    ...
    inputDataUrlTextField = new JTextField("src/GA/input/ficUni", 30);
    constraintsDataUrlTextField = new JTextField("src/GA/input/constraints", 30);
    mutationProbabilityTextField = new JTextField("60", 30);
    crossoverProbabilityTextField = new JTextField("500", 30);
