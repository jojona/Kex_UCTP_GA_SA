...
public class Population {
	...
	public TimeTable generateRandomInvidual(KTH kth, Map<Integer, Room> rooms, int numRooms) {
		...
		for (Event e : kth.getEvents().values()) {
			...
			/*
			 * DEBUG System.out.println("=============="); System.out.println(
			 * "ROOM TIME TABLE ID: " + rtt.getRoom().getName());
			 * System.out.println("Day: " + availableTimeSlot.day +
			 * " Timeslot: " + availableTimeSlot.timeSlot + " Event ID: " +
			 * e.getId());
			 */
		}
